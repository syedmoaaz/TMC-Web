      ...
      <section id="home" className="relative overflow-hidden bg-gradient-to-r from-[#FFF9EC] via-white to-[#EEF8FF] min-h-[calc(100vh-88px)] py-24 scroll-mt-28">
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-6 lg:px-8">
          <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
            <div>
              <h1 className="text-4xl font-black leading-[1.05] md:text-5xl lg:text-[58px]">
                <span className="text-violet-600">Where teachers</span>
                <br />
                <span className="text-orange-500">begin their</span>{" "}
